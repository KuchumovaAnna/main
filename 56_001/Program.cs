...
{
    for (int row = 0; row < CreateIntegerArray.GetLength(1); row++)
    {
...
{
    Console.WriteLine($"vivod masiva {nameOfArray}");
    for (int row = 0; row < arrayToShow.GetLength(0); row++)
    {
        for (int col = 0; col < arrayToShow.GetLength(0); col++)
        {
